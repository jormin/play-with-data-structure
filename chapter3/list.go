...
// 将线性表清空
func (l *List) ClearList() Status {
	l.InitList()
	return OK
}

// 将线性表L中的第i个位置元素值返回给e
func (l *List) GetElem(i int, e *ElemType) Status {
...
func (l *List) LocateElem(e ElemType) int {
	if l.Length == 0 {
		return 0
	}
...
// 在线性表L的第i个位置插入新元素e
func (l *List) ListInsert(i int, e ElemType) Status {
	// 如果当前线性表长度已达最大值则返回失败
	if l.Length == MaxSize {
		return Error
	}
...
func (l *List) ListDelete(i int, e *ElemType) Status {
	// 如果当前线性表长度为0则返回失败
	if l.Length == 0 {
		return Error
	}
